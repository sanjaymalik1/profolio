...
export function ElegantMonochromeTemplate({ data, isPreview = false, sections, renderSection }: ElegantMonochromeTemplateProps) {
                ...
                <React.Fragment key={section.id || index}>
                  ...
                  <section className="py-24 px-6 bg-gray-100">
                    <div className="max-w-6xl mx-auto">
                      ...
                      >
                        <h2 className="text-4xl font-light text-gray-900 mb-4">{contactData.heading}</h2>
                        <div className="w-16 h-px bg-gray-400 mx-auto mb-8"></div>

                        <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
                          {contactData.availability || "Ready to transform your business? Let's discuss how we can achieve your strategic objectives together."}
                        </p>
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-8 max-w-2xl mx-auto shadow-sm">
                          ...
                          <motion.a
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="inline-flex items-center gap-3 px-8 py-4 bg-gray-900 text-white rounded-lg font-medium hover:bg-gray-800 transition-all duration-300"
                          >
